...
export const energy = ["Invigorated", "Fatigued ", "Depleted"];
export const lovability = ["Lovable", "Unlovable"];
export const esteem = ["Confident", "Doubtful"];
export const pity = ["woe is me", "selfless"];