...
export default function CylinderGaugeModule2(props) {
  ...
  function renderCylinderGauge() {
    let chart = []
    chart[props.id] = am4core.create("cylinder-gauge2", am4charts.XYChart3D);
  ...
  return <div id="chart2" className="cylinder-gauge2"></div>;
}